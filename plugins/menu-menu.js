...
⊜ *Tokens ➟* ${joincount} 🪙
${readMore}
*╭━〔 INFORMACIÓN DE LUDMI BOT 〕⬣*
┃💫➺ ${usedPrefix}creador ➺ LUDMIBOT precios ➺ LUDMIinfo
┃💫➺ ${usedPrefix}creador ➺ LUDMIBOT
┃💫➺ ${usedPrefix}numero de mi creador ➺ 5493813300744
┃💫➺ ${usedPrefix}para comprar el bot ➺ wa.me/5493813300744
┃💫➺ ${usedPrefix}para ver precios del bot ➺ precios
┃💫➺ ${usedPrefix}para ver información del bot ➺ ludminfo
...
*╭━━[ BÚSQUEDAS 🔍 ]━━⬣*
┃ *Busca lo que quieres con GeriPium!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
handler.command = /^(menu2|menú|memu|memú|help|info|comandos|2help|menu1.2|ayuda|commands|commandos|menucompleto|allmenu|allm|m|\!)$/i
